# Fly.io + Cloudflare R2 + Custom VPN

This template sets up a Relay Server on Fly.io with Cloudflare R2 storage, accessible via your custom VPN or private network using Fly.io's private networking.
